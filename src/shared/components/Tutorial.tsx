  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-surface rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
        {/* 进度条 */}
        <div className="h-2 bg-border-DEFAULT">
          <div
        ...
        <div className="p-8">
          ...
          {/* 内容 */}
          <p className="text-text-secondary text-center leading-relaxed">{currentStepData.content}</p>
        ...
        {/* 按钮 */}
        <div className="bg-surface-subtle p-6 flex justify-between items-center">
          <button
          ...
          <div className="flex gap-3">
            {currentStep > 0 && (
              <button
                onClick={prevStep}
                className="px-6 py-2 border border-border-strong text-text-primary hover:bg-surface-muted transition-colors"
              >
                上一步
              </button>
            )}
